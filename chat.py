...
def main(page: ft.Page):
    ...
    page.dialog = ft.AlertDialog(
        ...
        actions=[ft.ElevatedButton(text="Join chat", on_click=join_click)],  # type: ignore
        actions_alignment="end",  # type: ignore
    )

    page.add(
        chat, ft.Row([new_message, ft.ElevatedButton("Send", on_click=send_click)])  # type: ignore
    )
